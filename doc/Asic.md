...
Initial tape-outs are done on commercial nodes using commercial tooling. Closed source tooling scripts will not be part of the repository.

## Open-source

Experimental open-source tape-out is done later. Once details are figured out, open source flow scripts are intended to be part of this repository.

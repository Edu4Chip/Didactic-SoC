...
module SystemControl(	// src/main/scala/dtu/SystemControl.scala:7:7
  ...
  reg  lerosResetReg;	// src/main/scala/dtu/SystemControl.scala:15:30
  reg  lerosBootFromRamReg;	// src/main/scala/dtu/SystemControl.scala:16:36
  wire apbPort_pready_0 = apbPort_psel & apbPort_penable;	// src/main/scala/dtu/SystemControl.scala:24:21
  always @(posedge clock) begin	// src/main/scala/dtu/SystemControl.scala:7:7
    if (reset) begin	// src/main/scala/dtu/SystemControl.scala:7:7
      lerosResetReg <= 1'h0;	// src/main/scala/dtu/SystemControl.scala:7:7, :15:30
      lerosBootFromRamReg <= 1'h0;	// src/main/scala/dtu/SystemControl.scala:7:7, :16:36
    end
    else if (apbPort_pready_0 & apbPort_pwrite) begin	// src/main/scala/dtu/SystemControl.scala:15:30, :24:{21,41}, :28:26, :29:21
      lerosResetReg <= apbPort_pwdata[0];	// src/main/scala/dtu/SystemControl.scala:15:30, :29:38
      lerosBootFromRamReg <= apbPort_pwdata[1];	// src/main/scala/dtu/SystemControl.scala:16:36, :30:44
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/dtu/SystemControl.scala:7:7
    ...
    initial begin	// src/main/scala/dtu/SystemControl.scala:7:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/dtu/SystemControl.scala:7:7
        ...
        lerosResetReg = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/dtu/SystemControl.scala:7:7, :15:30
        lerosBootFromRamReg = _RANDOM[/*Zero width*/ 1'b0][1];	// src/main/scala/dtu/SystemControl.scala:7:7, :15:30, :16:36
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign apbPort_pready = apbPort_pready_0;	// src/main/scala/dtu/SystemControl.scala:7:7, :24:21
  assign apbPort_prdata = {30'h0, lerosBootFromRamReg, lerosResetReg};	// src/main/scala/dtu/SystemControl.scala:7:7, :15:30, :16:36, :20:18
  assign ctrlPort_lerosReset = lerosResetReg;	// src/main/scala/dtu/SystemControl.scala:7:7, :15:30
  assign ctrlPort_lerosBootFromRam = lerosBootFromRamReg;	// src/main/scala/dtu/SystemControl.scala:7:7, :16:36
endmodule
...
module Rx(	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
  ...
  always @(posedge clock) begin	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
    if (reset) begin	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
      ...
      cntReg <= 20'h6C;	// leros/src/main/scala/leros/uart/UARTRx.scala:38:23
      ...
      if (|cntReg)	// leros/src/main/scala/leros/uart/UARTRx.scala:38:23, :42:15
        ...
        cntReg <= 20'hA1;	// leros/src/main/scala/leros/uart/UARTRx.scala:38:23, :53:12
...
module Tx(	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
  ...
  reg  [6:0]  cntReg;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23
  reg  [3:0]  bitsReg;	// leros/src/main/scala/leros/uart/UARTTx.scala:31:24
  wire        _io_channel_ready_T = cntReg == 7'h0;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :33:31
  always @(posedge clock) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    if (reset) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      ...
      cntReg <= 7'h0;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23
      ...
      else if (io_channel_valid) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:22:14
        shiftReg <= {2'h3, io_channel_bits, 1'h0};	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25, :45:{30,49}
        bitsReg <= 4'hB;	// leros/src/main/scala/leros/uart/UARTTx.scala:31:24, :46:17
      end
      if ((|bitsReg) | io_channel_valid)	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :31:24, :33:52, :38:27, :39:14, :43:34, :44:16
        cntReg <= 7'h6C;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :39:14
    end
    else	// leros/src/main/scala/leros/uart/UARTTx.scala:33:31
      cntReg <= cntReg - 7'h1;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :50:22
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    ...
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:0];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    initial begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
        shiftReg = _RANDOM[/*Zero width*/ 1'b0][10:0];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25
        cntReg = _RANDOM[/*Zero width*/ 1'b0][17:11];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25, :30:23
        bitsReg = _RANDOM[/*Zero width*/ 1'b0][21:18];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25, :31:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module Leros(	// leros/src/main/scala/leros/Leros.scala:13:7
  ...
  wire [7:0]  vecAccu_3;	// leros/src/main/scala/leros/Leros.scala:46:16, :84:20
  wire [7:0]  vecAccu_2;	// leros/src/main/scala/leros/Leros.scala:46:16, :84:20
  wire [7:0]  vecAccu_1;	// leros/src/main/scala/leros/Leros.scala:46:16, :84:20
  wire [31:0] _dec_io_dout_operand;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [3:0]  _dec_io_dout_enaMask;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [2:0]  _dec_io_dout_op;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [9:0]  _dec_io_dout_off;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [11:0] _dec_io_dout_brOff;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire        _dec_io_dout_useDecOpd;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [3:0]  _dec_io_dout_nextState;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire        _dec_io_dout_enaByte;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire        _dec_io_dout_enaHalf;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire        _dec_io_dout_isDataAccess;	// leros/src/main/scala/leros/Leros.scala:33:19
  wire [3:0]  _dec_io_dout_brType;	// leros/src/main/scala/leros/Leros.scala:33:19
  ...
  wire [9:0]  _dmemIO_wrData_T_6 = pcReg + 10'h1;	// leros/src/main/scala/leros/Leros.scala:23:22, :26:34
  reg  [31:0] decReg_operand;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg  [3:0]  decReg_enaMask;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg  [2:0]  decReg_op;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg  [11:0] decReg_brOff;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg         decReg_useDecOpd;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg         decReg_enaByte;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg         decReg_enaHalf;	// leros/src/main/scala/leros/Leros.scala:36:23
  reg  [3:0]  decReg_brType;	// leros/src/main/scala/leros/Leros.scala:36:23
  wire [15:0] _effAddr_T_1 = addrReg + {{6{_dec_io_dout_off[9]}}, _dec_io_dout_off};	// leros/src/main/scala/leros/Leros.scala:24:24, :33:19, :40:33
  wire [13:0] memAddr =
    _dec_io_dout_isDataAccess ? _effAddr_T_1[15:2] : {6'h0, imemIO_instr[7:0]};	// leros/src/main/scala/leros/Leros.scala:33:19, :40:33, :41:30, :53:{20,60}
  reg  [13:0] memAddrReg;	// leros/src/main/scala/leros/Leros.scala:54:27
  reg  [1:0]  effAddrOffReg;	// leros/src/main/scala/leros/Leros.scala:55:30
  reg  [3:0]  stateReg;	// leros/src/main/scala/leros/Leros.scala:76:25
  wire        _GEN = stateReg == 4'h1;	// leros/src/main/scala/leros/Leros.scala:76:25, :78:{18,29}, :79:14
  wire        _GEN_0 = stateReg == 4'h2;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire        _GEN_1 = stateReg == 4'h3;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire        _GEN_2 = stateReg == 4'h4;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire        _GEN_3 = stateReg == 4'h5;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire        _GEN_4 = stateReg == 4'h6;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire [7:0]  _GEN_5 = (&effAddrOffReg) ? _alu_io_accu[7:0] : _alu_io_accu[31:24];	// leros/src/main/scala/leros/Leros.scala:18:19, :46:{16,23}, :55:30, :112:30
  wire        _GEN_6 = stateReg == 4'h7;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire [4:0]  _dmemIO_wrMask_T_1 = 5'h3 << effAddrOffReg;	// leros/src/main/scala/leros/Leros.scala:55:30, :118:34
  wire        _GEN_7 = _GEN | _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3;	// leros/src/main/scala/leros/Leros.scala:61:17, :76:25, :78:{18,29}, :79:14, :84:20
  assign vecAccu_1 =
    _GEN_7 | ~((_GEN_4 | _GEN_6 & effAddrOffReg[1]) & effAddrOffReg == 2'h1)
      ? _alu_io_accu[15:8]
      : _alu_io_accu[7:0];	// leros/src/main/scala/leros/Leros.scala:13:7, :18:19, :46:{16,23}, :55:30, :61:17, :84:20, :112:30, :120:{29,36}
  assign vecAccu_2 =
    _GEN_7 | ~((_GEN_4 | _GEN_6) & effAddrOffReg == 2'h2)
      ? _alu_io_accu[23:16]
      : _alu_io_accu[7:0];	// leros/src/main/scala/leros/Leros.scala:13:7, :18:19, :46:{16,23}, :55:30, :61:17, :84:20, :112:30, :120:36
  assign vecAccu_3 =
    _GEN_7
      ? _alu_io_accu[31:24]
      : _GEN_4
          ...
          : _GEN_6
              ...
              : _alu_io_accu[31:24];	// leros/src/main/scala/leros/Leros.scala:18:19, :46:{16,23}, :55:30, :61:17, :84:20, :112:30, :119:30, :120:{29,36}
  wire        _GEN_8 = stateReg == 4'h8;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20
  wire        _GEN_9 = stateReg == 4'h9;	// leros/src/main/scala/leros/Leros.scala:76:25, :84:20, :126:29
  wire [9:0]  pcNext =
      ...
      : _GEN_8
          ? (decReg_brType == 4'h8
             | (decReg_brType == 4'h9
               ...
               : _dmemIO_wrData_T_6)
          : _GEN_9 ? _alu_io_accu[9:0] : _dmemIO_wrData_T_6;	// leros/src/main/scala/leros/Decode.scala:31:15, leros/src/main/scala/leros/Leros.scala:18:19, :23:22, :26:{27,34}, :36:23, :76:25, :78:{18,29}, :79:14, :84:20, :125:33, :126:29, :127:37, :128:{38,46}, :129:{39,47}, :130:{38,45,50}, :131:{38,45}, :133:23, :134:{16,33}, :139:14
  always @(posedge clock) begin	// leros/src/main/scala/leros/Leros.scala:13:7
    if (reset) begin	// leros/src/main/scala/leros/Leros.scala:13:7
      pcReg <= 10'h0;	// leros/src/main/scala/leros/Leros.scala:23:22
      addrReg <= 16'h0;	// leros/src/main/scala/leros/Leros.scala:24:24
      decReg_operand <= 32'h0;	// leros/src/main/scala/leros/Decode.scala:31:15, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_enaMask <= 4'h0;	// leros/src/main/scala/leros/Decode.scala:32:15, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_op <= 3'h0;	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
      decReg_brOff <= 12'h0;	// leros/src/main/scala/leros/Decode.scala:35:13, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_useDecOpd <= 1'h0;	// leros/src/main/scala/leros/Decode.scala:31:15, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_enaByte <= 1'h0;	// leros/src/main/scala/leros/Decode.scala:31:15, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_enaHalf <= 1'h0;	// leros/src/main/scala/leros/Decode.scala:31:15, leros/src/main/scala/leros/Leros.scala:36:23
      decReg_brType <= 4'h0;	// leros/src/main/scala/leros/Decode.scala:32:15, leros/src/main/scala/leros/Leros.scala:36:23
      stateReg <= 4'h1;	// leros/src/main/scala/leros/Leros.scala:76:25, :79:14
    end
    else begin	// leros/src/main/scala/leros/Leros.scala:13:7
      if (_GEN) begin	// leros/src/main/scala/leros/Leros.scala:76:25, :78:{18,29}, :79:14
        decReg_operand <= _dec_io_dout_operand;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_enaMask <= _dec_io_dout_enaMask;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_op <= _dec_io_dout_op;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_brOff <= _dec_io_dout_brOff;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_useDecOpd <= _dec_io_dout_useDecOpd;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_enaByte <= _dec_io_dout_enaByte;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_enaHalf <= _dec_io_dout_enaHalf;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        decReg_brType <= _dec_io_dout_brType;	// leros/src/main/scala/leros/Leros.scala:33:19, :36:23
        stateReg <= _dec_io_dout_nextState;	// leros/src/main/scala/leros/Leros.scala:33:19, :76:25
      end
      else begin	// leros/src/main/scala/leros/Leros.scala:76:25, :78:{18,29}, :79:14
        pcReg <= pcNext;	// leros/src/main/scala/leros/Leros.scala:23:22, :26:27, :84:20
        stateReg <= 4'h1;	// leros/src/main/scala/leros/Leros.scala:76:25, :79:14
      end
      if (_GEN | ~_GEN_0) begin	// leros/src/main/scala/leros/Leros.scala:24:24, :76:25, :78:{18,29}, :79:14, :84:20
      end
      else	// leros/src/main/scala/leros/Leros.scala:24:24, :84:20
        addrReg <= dmemIO_rdData[15:0];	// leros/src/main/scala/leros/Leros.scala:24:24, :93:15
    end
    memAddrReg <= memAddr;	// leros/src/main/scala/leros/Leros.scala:53:20, :54:27
    effAddrOffReg <= _effAddr_T_1[1:0];	// leros/src/main/scala/leros/Leros.scala:40:33, :43:25, :55:30
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// leros/src/main/scala/leros/Leros.scala:13:7
    ...
    initial begin	// leros/src/main/scala/leros/Leros.scala:13:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// leros/src/main/scala/leros/Leros.scala:13:7
        ...
        decReg_operand = {_RANDOM[2'h0][31:26], _RANDOM[2'h1][25:0]};	// leros/src/main/scala/leros/Leros.scala:13:7, :23:22, :36:23
        decReg_enaMask = _RANDOM[2'h1][29:26];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_op = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][0]};	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_brOff = _RANDOM[2'h2][22:11];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_useDecOpd = _RANDOM[2'h2][24];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_enaByte = _RANDOM[2'h2][29];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_enaHalf = _RANDOM[2'h2][30];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        decReg_brType = _RANDOM[2'h3][3:0];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23
        memAddrReg = _RANDOM[2'h3][17:4];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23, :54:27
        effAddrOffReg = _RANDOM[2'h3][19:18];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23, :55:30
        stateReg = _RANDOM[2'h3][24:21];	// leros/src/main/scala/leros/Leros.scala:13:7, :36:23, :76:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  AluAccu alu (	// leros/src/main/scala/leros/Leros.scala:18:19
    .clock      (clock),
    .reset      (reset),
    .io_op      (decReg_op),	// leros/src/main/scala/leros/Leros.scala:36:23
    .io_din     (decReg_useDecOpd ? decReg_operand : dmemIO_rdData),	// leros/src/main/scala/leros/Leros.scala:36:23, :71:20
    .io_enaMask (_GEN ? 4'h0 : decReg_enaMask),	// leros/src/main/scala/leros/Decode.scala:32:15, leros/src/main/scala/leros/Leros.scala:36:23, :65:18, :76:25, :78:{18,29}, :79:14, :81:20
    .io_enaByte (decReg_enaByte),	// leros/src/main/scala/leros/Leros.scala:36:23
    .io_enaHalf (decReg_enaHalf),	// leros/src/main/scala/leros/Leros.scala:36:23
    .io_off     (effAddrOffReg),	// leros/src/main/scala/leros/Leros.scala:55:30
    .io_accu    (_alu_io_accu)
  );
  Decode dec (	// leros/src/main/scala/leros/Leros.scala:33:19
    .io_din               (imemIO_instr),
  ...
  assign imemIO_addr = pcNext;	// leros/src/main/scala/leros/Leros.scala:13:7, :26:27, :84:20
  assign dmemIO_rdAddr = {2'h0, memAddr};	// leros/src/main/scala/leros/Leros.scala:13:7, :53:20, :56:17
  assign dmemIO_wrAddr = {2'h0, memAddrReg};	// leros/src/main/scala/leros/Leros.scala:13:7, :54:27, :58:17
  assign dmemIO_wrData =
    _GEN_7
      ...
      : _GEN_4
          ...
          : _GEN_6
              ? {vecAccu_3, vecAccu_2, vecAccu_1, _alu_io_accu[7:0]}
              : _GEN_8 | ~_GEN_9 ? _alu_io_accu : {22'h0, _dmemIO_wrData_T_6};	// leros/src/main/scala/leros/Leros.scala:13:7, :18:19, :26:{27,34}, :46:{16,23}, :59:17, :61:17, :84:20, :113:{21,63}, :121:{21,63}, :139:14, :141:21
  assign dmemIO_wr =
    ~(_GEN | _GEN_0 | _GEN_1) & (_GEN_2 | _GEN_3 | _GEN_4 | _GEN_6 | ~_GEN_8 & _GEN_9);	// leros/src/main/scala/leros/Leros.scala:13:7, :60:13, :76:25, :78:{18,29}, :79:14, :84:20, :101:17, :105:17, :110:17, :117:17
  assign dmemIO_wrMask =
    _GEN_7
      ? 4'hF
      : _GEN_4 ? 4'h1 << effAddrOffReg : _GEN_6 ? _dmemIO_wrMask_T_1[3:0] : 4'hF;	// leros/src/main/scala/leros/Leros.scala:13:7, :55:30, :61:17, :79:14, :84:20, :111:{21,34}, :118:{21,34}
endmodule

// external module sp_sram

module DidacticSpSram(	// src/main/scala/mem/DidacticSpSram.scala:18:7
  ...
  sp_sram #(
    ...
    .INIT_FILE(""),
    .NUM_WORDS(256)
  ) mem (	// src/main/scala/mem/DidacticSpSram.scala:30:43
    .clk_i       (clock),
    .rst_ni      (~reset),	// src/main/scala/mem/DidacticSpSram.scala:35:20
    .req_i       (io_req),
    .we_i        (io_write),
    .rready_i    (1'h1),	// src/main/scala/mem/DidacticSpSram.scala:38:19
    .addr_i      (io_wordAddr),
    .wdata_i     (io_wrData),
    .be_i        (io_mask),
    .rdata_o     (io_rdData),
...
module InstructionMemory(	// src/main/scala/dtu/InstructionMemory.scala:30:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/dtu/InstructionMemory.scala:30:7
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  DidacticSpSram m (	// src/main/scala/mem/DidacticSpSram.scala:8:19
    .clock       (clock),
    .reset       (reset),
    .io_req      (~apbPort_psel | ~apbPort_pwrite | apbPort_penable & apbPort_pwrite),	// src/main/scala/dtu/InstructionMemory.scala:51:22, :55:{10,27}, :57:32, src/main/scala/mem/DidacticSpSram.scala:47:12
    .io_wordAddr
      (apbPort_psel
         ? (apbPort_pwrite ? apbPort_paddr[9:2] : apbPort_paddr[9:2])
         : instrPort_addr[8:1]),	// src/main/scala/dtu/InstructionMemory.scala:51:22, :55:27, :56:47, :57:51, :59:22, :67:39, src/main/scala/mem/DidacticSpSram.scala:49:17
    .io_write    (apbPort_psel & apbPort_pwrite),	// src/main/scala/dtu/InstructionMemory.scala:51:22, :55:27, src/main/scala/mem/DidacticSpSram.scala:48:14
...
module InstrMem(	// leros/src/main/scala/leros/InstrMem.scala:19:7
  ...
  always_comb begin	// leros/src/main/scala/leros/InstrMem.scala:27:12
    casez (memReg[4:0])	// leros/src/main/scala/leros/InstrMem.scala:24:23, :27:{12,29}
      ...
      5'b10000:
        casez_tmp = 16'h8FF8;	// leros/src/main/scala/leros/InstrMem.scala:27:12
      5'b10001:
        casez_tmp = 16'h0;	// leros/src/main/scala/leros/InstrMem.scala:27:12
      5'b10010:
        casez_tmp = 16'h0;	// leros/src/main/scala/leros/InstrMem.scala:27:12
...
module DataMemory(	// src/main/scala/dtu/DataMemory.scala:16:7
  ...
  DidacticSpSram m (	// src/main/scala/mem/DidacticSpSram.scala:8:19
    .clock       (clock),
    .reset       (reset),
    .io_req      (1'h1),	// src/main/scala/mem/DidacticSpSram.scala:47:12
    .io_wordAddr (dmemPort_wr ? dmemPort_wrAddr : dmemPort_rdAddr),	// src/main/scala/dtu/DataMemory.scala:26:21, src/main/scala/mem/DidacticSpSram.scala:49:17, :55:17
...
module Tx_1(	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
  input        clock,	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
               reset,	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
  output       io_txd,	// leros/src/main/scala/leros/uart/UARTTx.scala:22:14
               io_channel_ready,	// leros/src/main/scala/leros/uart/UARTTx.scala:22:14
  ...
  reg  [10:0] shiftReg;	// leros/src/main/scala/leros/uart/UARTTx.scala:29:25
  reg  [9:0]  cntReg;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23
  reg  [3:0]  bitsReg;	// leros/src/main/scala/leros/uart/UARTTx.scala:31:24
  wire        _io_channel_ready_T = cntReg == 10'h0;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :33:31
  always @(posedge clock) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    if (reset) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      shiftReg <= 11'h7FF;	// leros/src/main/scala/leros/uart/UARTTx.scala:29:25
      cntReg <= 10'h0;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23
      bitsReg <= 4'h0;	// leros/src/main/scala/leros/uart/UARTTx.scala:31:24
    end
    else if (_io_channel_ready_T) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:33:31
      if (|bitsReg) begin	// leros/src/main/scala/leros/uart/UARTTx.scala:31:24, :33:52
      ...
      if ((|bitsReg) | io_channel_valid)	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :31:24, :33:52, :38:27, :39:14, :43:34, :44:16
        cntReg <= 10'h363;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :39:14
    end
    else	// leros/src/main/scala/leros/uart/UARTTx.scala:33:31
      cntReg <= cntReg - 10'h1;	// leros/src/main/scala/leros/uart/UARTTx.scala:30:23, :50:22
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    `ifdef FIRRTL_BEFORE_INITIAL	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      `FIRRTL_BEFORE_INITIAL	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
    ...
    initial begin	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
        shiftReg = _RANDOM[/*Zero width*/ 1'b0][10:0];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25
        cntReg = _RANDOM[/*Zero width*/ 1'b0][20:11];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25, :30:23
        bitsReg = _RANDOM[/*Zero width*/ 1'b0][24:21];	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7, :29:25, :31:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
      `FIRRTL_AFTER_INITIAL	// leros/src/main/scala/leros/uart/UARTTx.scala:21:7
...
module BufferedTx(	// leros/src/main/scala/leros/uart/UARTTx.scala:58:7
  input        clock,	// leros/src/main/scala/leros/uart/UARTTx.scala:58:7
               reset,	// leros/src/main/scala/leros/uart/UARTTx.scala:58:7
  output       io_txd,	// leros/src/main/scala/leros/uart/UARTTx.scala:59:14
               io_channel_ready,	// leros/src/main/scala/leros/uart/UARTTx.scala:59:14
  input        io_channel_valid,	// leros/src/main/scala/leros/uart/UARTTx.scala:59:14
  input  [7:0] io_channel_bits	// leros/src/main/scala/leros/uart/UARTTx.scala:59:14
);

  wire       _buf_io_out_valid;	// leros/src/main/scala/leros/uart/UARTTx.scala:64:19
  wire [7:0] _buf_io_out_bits;	// leros/src/main/scala/leros/uart/UARTTx.scala:64:19
  wire       _tx_io_channel_ready;	// leros/src/main/scala/leros/uart/UARTTx.scala:63:18
  Tx_1 tx (	// leros/src/main/scala/leros/uart/UARTTx.scala:63:18
    .clock            (clock),
    .reset            (reset),
    .io_txd           (io_txd),
    .io_channel_ready (_tx_io_channel_ready),
    .io_channel_valid (_buf_io_out_valid),	// leros/src/main/scala/leros/uart/UARTTx.scala:64:19
    .io_channel_bits  (_buf_io_out_bits)	// leros/src/main/scala/leros/uart/UARTTx.scala:64:19
  );
  Buffer buf_0 (	// leros/src/main/scala/leros/uart/UARTTx.scala:64:19
    .clock        (clock),
    .reset        (reset),
    .io_in_ready  (io_channel_ready),
    .io_in_valid  (io_channel_valid),
    .io_in_bits   (io_channel_bits),
    .io_out_ready (_tx_io_channel_ready),	// leros/src/main/scala/leros/uart/UARTTx.scala:63:18
    .io_out_valid (_buf_io_out_valid),
    .io_out_bits  (_buf_io_out_bits)
  );
endmodule

module Rx_1(	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
  input        clock,	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
               reset,	// leros/src/main/scala/leros/uart/UARTRx.scala:24:7
               io_rxd,	// leros/src/main/scala/leros/uart/UARTRx.scala:25:14
               io_channel_ready,	// leros/src/main/scala/leros/uart/UARTRx.scala:25:14
...
module UARTRx(	// leros/src/main/scala/leros/uart/UARTRx.scala:102:7
  ...
  Rx_1 rx (	// leros/src/main/scala/leros/uart/UARTRx.scala:107:18
    .clock            (clock),
    .reset            (reset),
    .io_rxd           (io_rxd),
...
module ApbMux(	// src/main/scala/apb/ApbMux.scala:14:7
  input  [15:0] io_master_paddr,	// src/main/scala/apb/ApbMux.scala:20:14
  input         io_master_psel,	// src/main/scala/apb/ApbMux.scala:20:14
                io_master_penable,	// src/main/scala/apb/ApbMux.scala:20:14
                io_master_pwrite,	// src/main/scala/apb/ApbMux.scala:20:14
  input  [3:0]  io_master_pstrb,	// src/main/scala/apb/ApbMux.scala:20:14
  input  [31:0] io_master_pwdata,	// src/main/scala/apb/ApbMux.scala:20:14
  output        io_master_pready,	// src/main/scala/apb/ApbMux.scala:20:14
  output [31:0] io_master_prdata,	// src/main/scala/apb/ApbMux.scala:20:14
  output [15:0] io_targets_0_paddr,	// src/main/scala/apb/ApbMux.scala:20:14
  output        io_targets_0_psel,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_0_penable,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_0_pwrite,	// src/main/scala/apb/ApbMux.scala:20:14
  output [3:0]  io_targets_0_pstrb,	// src/main/scala/apb/ApbMux.scala:20:14
  output [31:0] io_targets_0_pwdata,	// src/main/scala/apb/ApbMux.scala:20:14
  input         io_targets_0_pready,	// src/main/scala/apb/ApbMux.scala:20:14
  input  [31:0] io_targets_0_prdata,	// src/main/scala/apb/ApbMux.scala:20:14
  output [15:0] io_targets_1_paddr,	// src/main/scala/apb/ApbMux.scala:20:14
  output        io_targets_1_psel,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_1_penable,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_1_pwrite,	// src/main/scala/apb/ApbMux.scala:20:14
  output [31:0] io_targets_1_pwdata,	// src/main/scala/apb/ApbMux.scala:20:14
  input         io_targets_1_pready,	// src/main/scala/apb/ApbMux.scala:20:14
  input  [31:0] io_targets_1_prdata,	// src/main/scala/apb/ApbMux.scala:20:14
  output        io_targets_2_psel,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_2_penable,	// src/main/scala/apb/ApbMux.scala:20:14
                io_targets_2_pwrite,	// src/main/scala/apb/ApbMux.scala:20:14
  output [31:0] io_targets_2_pwdata,	// src/main/scala/apb/ApbMux.scala:20:14
  input         io_targets_2_pready,	// src/main/scala/apb/ApbMux.scala:20:14
  input  [31:0] io_targets_2_prdata	// src/main/scala/apb/ApbMux.scala:20:14
);

  wire selected = io_master_psel & io_master_paddr[15:10] == 6'h0;	// src/main/scala/apb/ApbMux.scala:48:{35,53}, :51:7
  wire selected_1 = io_master_psel & io_master_paddr[15:4] == 12'h80;	// src/main/scala/apb/ApbMux.scala:48:{35,53}, :51:7
  wire selected_2 = io_master_psel & io_master_paddr[15:2] == 14'h300;	// src/main/scala/apb/ApbMux.scala:48:{35,53}, :51:7
  assign io_master_pready =
    selected_2
      ? io_targets_2_pready
      : selected_1
          ? io_targets_1_pready
          : selected ? io_targets_0_pready : io_targets_2_pready;	// src/main/scala/apb/ApbMux.scala:14:7, :29:7, :48:35, :53:20, :55:24
  assign io_master_prdata =
    selected_2
      ? io_targets_2_prdata
      : selected_1
          ? io_targets_1_prdata
          : selected ? io_targets_0_prdata : io_targets_2_prdata;	// src/main/scala/apb/ApbMux.scala:14:7, :29:7, :48:35, :53:20, :56:24
  assign io_targets_0_paddr = io_master_paddr;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_0_psel = selected;	// src/main/scala/apb/ApbMux.scala:14:7, :48:35
  assign io_targets_0_penable = io_master_penable;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_0_pwrite = io_master_pwrite;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_0_pstrb = io_master_pstrb;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_0_pwdata = io_master_pwdata;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_1_paddr = io_master_paddr;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_1_psel = selected_1;	// src/main/scala/apb/ApbMux.scala:14:7, :48:35
  assign io_targets_1_penable = io_master_penable;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_1_pwrite = io_master_pwrite;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_1_pwdata = io_master_pwdata;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_2_psel = selected_2;	// src/main/scala/apb/ApbMux.scala:14:7, :48:35
  assign io_targets_2_penable = io_master_penable;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_2_pwrite = io_master_pwrite;	// src/main/scala/apb/ApbMux.scala:14:7
  assign io_targets_2_pwdata = io_master_pwdata;	// src/main/scala/apb/ApbMux.scala:14:7
endmodule
...
module DtuSubsystem(	// src/main/scala/dtu/DtuSubsystem.scala:56:7
  input         clock,	// src/main/scala/dtu/DtuSubsystem.scala:56:7
                reset,	// src/main/scala/dtu/DtuSubsystem.scala:56:7
  input  [11:0] io_apb_paddr,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input         io_apb_psel,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
                io_apb_penable,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
                io_apb_pwrite,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input  [3:0]  io_apb_pstrb,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input  [31:0] io_apb_pwdata,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  output        io_apb_pready,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  output [31:0] io_apb_prdata,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  output        io_apb_pslverr,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
                io_irq,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input         io_irqEn,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input  [7:0]  io_ssCtrl,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  input  [15:0] io_gpio_in,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
  output [15:0] io_gpio_out,	// src/main/scala/dtu/DtuSubsystem.scala:58:14
                io_gpio_outputEnable	// src/main/scala/dtu/DtuSubsystem.scala:58:14
);
  ...
  wire        _apbMux_io_master_pready;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [31:0] _apbMux_io_master_prdata;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [15:0] _apbMux_io_targets_0_paddr;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_0_psel;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_0_penable;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_0_pwrite;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [3:0]  _apbMux_io_targets_0_pstrb;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [31:0] _apbMux_io_targets_0_pwdata;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [15:0] _apbMux_io_targets_1_paddr;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_1_psel;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_1_penable;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_1_pwrite;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [31:0] _apbMux_io_targets_1_pwdata;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_2_psel;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_2_penable;	// src/main/scala/apb/ApbMux.scala:86:24
  wire        _apbMux_io_targets_2_pwrite;	// src/main/scala/apb/ApbMux.scala:86:24
  wire [31:0] _apbMux_io_targets_2_pwdata;	// src/main/scala/apb/ApbMux.scala:86:24
  ...
  wire        _uart_uartPins_tx;	// src/main/scala/dtu/DtuSubsystem.scala:78:20
  wire [31:0] _uart_dmemPort_rdData;	// src/main/scala/dtu/DtuSubsystem.scala:78:20
  wire [31:0] _dmem_dmemPort_rdData;	// src/main/scala/dtu/DtuSubsystem.scala:77:20
  wire [31:0] _gpio_dmemPort_rdData;	// src/main/scala/dtu/DtuSubsystem.scala:76:20
  wire [11:0] _gpio_gpioPort_out;	// src/main/scala/dtu/DtuSubsystem.scala:76:20
  wire [11:0] _gpio_gpioPort_outputEnable;	// src/main/scala/dtu/DtuSubsystem.scala:76:20
  wire        _regBlock_apbPort_pready;	// src/main/scala/dtu/DtuSubsystem.scala:75:24
  wire [31:0] _regBlock_apbPort_prdata;	// src/main/scala/dtu/DtuSubsystem.scala:75:24
  wire [31:0] _regBlock_dmemPort_rdData;	// src/main/scala/dtu/DtuSubsystem.scala:75:24
  wire [15:0] _rom_io_instr;	// src/main/scala/dtu/DtuSubsystem.scala:72:19
  wire [15:0] _instrMem_instrPort_instr;	// src/main/scala/dtu/DtuSubsystem.scala:71:24
  wire        _instrMem_apbPort_pready;	// src/main/scala/dtu/DtuSubsystem.scala:71:24
  wire [31:0] _instrMem_apbPort_prdata;	// src/main/scala/dtu/DtuSubsystem.scala:71:24
  wire [9:0]  _leros_imemIO_addr;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire [15:0] _leros_dmemIO_rdAddr;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire [15:0] _leros_dmemIO_wrAddr;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire [31:0] _leros_dmemIO_wrData;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire        _leros_dmemIO_wr;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire [3:0]  _leros_dmemIO_wrMask;	// src/main/scala/dtu/DtuSubsystem.scala:68:21
  wire        _ponte_io_uart_tx;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire [15:0] _ponte_io_apb_paddr;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire        _ponte_io_apb_psel;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire        _ponte_io_apb_penable;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire        _ponte_io_apb_pwrite;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire [31:0] _ponte_io_apb_pwdata;	// src/main/scala/dtu/DtuSubsystem.scala:65:21
  wire        _sysCtrl_apbPort_pready;	// src/main/scala/dtu/DtuSubsystem.scala:64:23
  wire [31:0] _sysCtrl_apbPort_prdata;	// src/main/scala/dtu/DtuSubsystem.scala:64:23
  wire        _sysCtrl_ctrlPort_lerosReset;	// src/main/scala/dtu/DtuSubsystem.scala:64:23
  wire        _sysCtrl_ctrlPort_lerosBootFromRam;	// src/main/scala/dtu/DtuSubsystem.scala:64:23
  SystemControl sysCtrl (	// src/main/scala/dtu/DtuSubsystem.scala:64:23
    .clock                     (clock),
    .reset                     (reset),
    .apbPort_psel              (_apbMux_io_targets_2_psel),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_penable           (_apbMux_io_targets_2_penable),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwrite            (_apbMux_io_targets_2_pwrite),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwdata            (_apbMux_io_targets_2_pwdata),	// src/main/scala/apb/ApbMux.scala:86:24
  ...
  Ponte ponte (	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    .clock          (clock),
    .reset          (reset),
    .io_uart_tx     (_ponte_io_uart_tx),
    .io_uart_rx     (io_gpio_in[1]),	// src/main/scala/dtu/DtuSubsystem.scala:62:27
  ...
  Leros leros (	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .clock         (clock),
    .reset         (reset | _sysCtrl_ctrlPort_lerosReset),	// src/main/scala/dtu/DtuSubsystem.scala:64:23, :69:31
    .imemIO_addr   (_leros_imemIO_addr),
    .imemIO_instr
      (_sysCtrl_ctrlPort_lerosBootFromRam ? _instrMem_instrPort_instr : _rom_io_instr),	// src/main/scala/dtu/DtuSubsystem.scala:64:23, :71:24, :72:19, :83:28
  ...
  InstructionMemory instrMem (	// src/main/scala/dtu/DtuSubsystem.scala:71:24
    .clock           (clock),
    .reset           (reset),
    .instrPort_addr  (_leros_imemIO_addr),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .instrPort_instr (_instrMem_instrPort_instr),
    .apbPort_paddr   (_apbMux_io_targets_0_paddr[9:0]),	// src/main/scala/apb/ApbMux.scala:86:24, :92:16
    .apbPort_psel    (_apbMux_io_targets_0_psel),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_penable (_apbMux_io_targets_0_penable),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwrite  (_apbMux_io_targets_0_pwrite),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pstrb   (_apbMux_io_targets_0_pstrb),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwdata  (_apbMux_io_targets_0_pwdata),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pready  (_instrMem_apbPort_pready),
    .apbPort_prdata  (_instrMem_apbPort_prdata)
  );
  InstrMem rom (	// src/main/scala/dtu/DtuSubsystem.scala:72:19
    .clock    (clock),
    .reset    (reset),
    .io_addr  (_leros_imemIO_addr),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_instr (_rom_io_instr)
  );
  RegBlock regBlock (	// src/main/scala/dtu/DtuSubsystem.scala:75:24
    .clock           (clock),
    .reset           (reset),
    .apbPort_paddr   (_apbMux_io_targets_1_paddr[3:0]),	// src/main/scala/apb/ApbMux.scala:86:24, :92:16
    .apbPort_psel    (_apbMux_io_targets_1_psel),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_penable (_apbMux_io_targets_1_penable),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwrite  (_apbMux_io_targets_1_pwrite),	// src/main/scala/apb/ApbMux.scala:86:24
    .apbPort_pwdata  (_apbMux_io_targets_1_pwdata),	// src/main/scala/apb/ApbMux.scala:86:24
  ...
  Gpio gpio (	// src/main/scala/dtu/DtuSubsystem.scala:76:20
    .clock                 (clock),
    .reset                 (reset),
    ...
    .gpioPort_in           (io_gpio_in[15:4]),	// src/main/scala/dtu/DtuSubsystem.scala:111:33
    .gpioPort_out          (_gpio_gpioPort_out),
    .gpioPort_outputEnable (_gpio_gpioPort_outputEnable)
  );
  DataMemory dmem (	// src/main/scala/dtu/DtuSubsystem.scala:77:20
    .clock           (clock),
    .reset           (reset),
  ...
  Uart uart (	// src/main/scala/dtu/DtuSubsystem.scala:78:20
    .clock           (clock),
    .reset           (reset),
    .uartPins_tx     (_uart_uartPins_tx),
    .uartPins_rx     (io_gpio_in[3]),	// src/main/scala/dtu/DtuSubsystem.scala:61:27
  ...
  ApbArbiter arb (	// src/main/scala/apb/ApbArbiter.scala:11:21
    .clock                (clock),
    .reset                (reset),
    .io_masters_0_paddr   (_ponte_io_apb_paddr),	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    .io_masters_0_psel    (_ponte_io_apb_psel),	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    .io_masters_0_penable (_ponte_io_apb_penable),	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    .io_masters_0_pwrite  (_ponte_io_apb_pwrite),	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    .io_masters_0_pwdata  (_ponte_io_apb_pwdata),	// src/main/scala/dtu/DtuSubsystem.scala:65:21
    ...
    .io_merged_pready     (_apbMux_io_master_pready),	// src/main/scala/apb/ApbMux.scala:86:24
    .io_merged_prdata     (_apbMux_io_master_prdata)	// src/main/scala/apb/ApbMux.scala:86:24
  );
  ApbMux apbMux (	// src/main/scala/apb/ApbMux.scala:86:24
    ...
    .io_targets_0_pready  (_instrMem_apbPort_pready),	// src/main/scala/dtu/DtuSubsystem.scala:71:24
    .io_targets_0_prdata  (_instrMem_apbPort_prdata),	// src/main/scala/dtu/DtuSubsystem.scala:71:24
    ...
    .io_targets_1_pready  (_regBlock_apbPort_pready),	// src/main/scala/dtu/DtuSubsystem.scala:75:24
    .io_targets_1_prdata  (_regBlock_apbPort_prdata),	// src/main/scala/dtu/DtuSubsystem.scala:75:24
    ...
    .io_targets_2_pready  (_sysCtrl_apbPort_pready),	// src/main/scala/dtu/DtuSubsystem.scala:64:23
    .io_targets_2_prdata  (_sysCtrl_apbPort_prdata)	// src/main/scala/dtu/DtuSubsystem.scala:64:23
  );
  DataMemMux dmemMux (	// src/main/scala/dtu/DataMemMux.scala:116:25
    .clock               (clock),
    .reset               (reset),
    .io_master_rdAddr    (_leros_dmemIO_rdAddr),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_master_rdData    (_dmemMux_io_master_rdData),
    .io_master_wrAddr    (_leros_dmemIO_wrAddr),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_master_wrData    (_leros_dmemIO_wrData),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_master_wr        (_leros_dmemIO_wr),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_master_wrMask    (_leros_dmemIO_wrMask),	// src/main/scala/dtu/DtuSubsystem.scala:68:21
    .io_targets_0_rdAddr (_dmemMux_io_targets_0_rdAddr),
    .io_targets_0_rdData (_dmem_dmemPort_rdData),	// src/main/scala/dtu/DtuSubsystem.scala:77:20
    ...
    .io_targets_1_rdData (_regBlock_dmemPort_rdData),	// src/main/scala/dtu/DtuSubsystem.scala:75:24
    ...
    .io_targets_2_rdData (_gpio_dmemPort_rdData),	// src/main/scala/dtu/DtuSubsystem.scala:76:20
    ...
    .io_targets_3_rdData (_uart_dmemPort_rdData),	// src/main/scala/dtu/DtuSubsystem.scala:78:20
  ...
  assign io_apb_pslverr = 1'h0;	// src/main/scala/apb/ApbArbiter.scala:11:21, src/main/scala/apb/ApbMux.scala:86:24, src/main/scala/dtu/DtuSubsystem.scala:56:7, :64:23, :65:21, :71:24, :75:24
  assign io_irq = 1'h0;	// src/main/scala/apb/ApbArbiter.scala:11:21, src/main/scala/apb/ApbMux.scala:86:24, src/main/scala/dtu/DtuSubsystem.scala:56:7, :64:23, :65:21, :71:24, :75:24
  assign io_gpio_out =
    {_gpio_gpioPort_out, 1'h0, _uart_uartPins_tx, 1'h0, _ponte_io_uart_tx};	// src/main/scala/apb/ApbArbiter.scala:11:21, src/main/scala/apb/ApbMux.scala:86:24, src/main/scala/dtu/DtuSubsystem.scala:56:7, :64:23, :65:21, :71:24, :75:24, :76:20, :78:20, :104:36
  assign io_gpio_outputEnable = {_gpio_gpioPort_outputEnable, 4'hA};	// src/main/scala/dtu/DtuSubsystem.scala:56:7, :76:20, :110:54
endmodule
